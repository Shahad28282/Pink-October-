...
<body>
    ...
    <img src="https://www.cancer.gov/images/cancer/1385_2_4.jpg" alt="شعار أكتوبر الوردي" style="max-width: 100%; height: auto; margin: 20px 0;"> <!-- رابط الصورة -->
    
    <div class="section">
        <h2>ما هو سرطان الثدي؟</h2>
        <img src="https://www.cancer.gov/images/cancer/1385_2_1.jpg" alt="سرطان الثدي" style="max-width: 100%; height: auto; border-radius: 10px;"> <!-- صورة توضيحية -->
        <p>
        ...
        <img src="https://www.cancer.gov/images/cancer/1385_2_3.jpg" alt="أعراض سرطان الثدي" style="max-width: 100%; height: auto; border-radius: 10px;"> <!-- صورة توضيحية -->
        <p>
        ...
        <img src="https://www.cancer.gov/images/cancer/1385_2_2.jpg" alt="أسباب سرطان الثدي" style="max-width: 100%; height: auto; border-radius: 10px;"> <!-- صورة توضيحية -->
        <p>
